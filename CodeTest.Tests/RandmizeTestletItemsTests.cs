namespace CodeTest.Tests
{
    ...
    using System.Linq;
    using CodeTest.Implementations;
    using CodeTest.Interfaces;
    using Xunit;

    public class RandmizeTestletItemsTests
    {
        ...
        private ITestletItemsRandomizer CreateDefaultTestletItemsRandomizer() => new RandmizeTestletItems(NumberOfFirstPretestItems, new Random(100500));

        private RandmizeTestletItems CreatePseudoRandomTestletItemsRandomizer(IReadOnlyList<int> pseudoRandomIntegers)
            => new RandmizeTestletItems(NumberOfFirstPretestItems, new GenerateFakeRandom(pseudoRandomIntegers));
