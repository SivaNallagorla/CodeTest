namespace CodeTest.Tests
{
    ...
    public class TestletValidatorTests
    {
        ...
        public void Validator_throws_exception_when_passed_more_or_less_than_10_items(int numberOfItems)
        {
            ...
            var exception = Assert.Throws<FixedNumberOfItemsException>(createTestlet);
            ...
            ItemType secondItemsType)
        {
            ...
            var exception = Assert.Throws<AggregateException>(createTestlet);
        ...
        private IValidateTestlet CreateDefaultTestletValidator() => new ValidateTestlet();
    }
}
